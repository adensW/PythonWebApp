...
if (typeof(Vue)!=='undefined') {
    ...
    Vue.component('pagination', {
        template: '<ul class="aden-pagination">' +
                '<li v-if="! has_previous" class="aden-disabled"><span><i class="uk-icon-angle-double-left"></i></span></li>' +
                '<li v-if="has_previous"><a v-attr="onclick:\'gotoPage(\' + (page_index-1) + \')\'" href="#0"><i class="uk-icon-angle-double-left"></i></a></li>' +
                '<li class="aden-active"><span v-text="page_index"></span></li>' +
                '<li v-if="! has_next" class="aden-disabled"><span><i class="uk-icon-angle-double-right"></i></span></li>' +
